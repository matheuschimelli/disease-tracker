...
const googleStrategyConfig = new GoogleStrategy({
  clientID: '344255178147-n299dkn16ho1998qlp1jun91v78mhked.apps.googleusercontent.com',
  clientSecret: 'SxaDyp6VCZD9BXeZmtZSNjCt',
...
export function isAuthenticated (req, res, next) {
  ...
  return res.status(403).json({ msg: 'Missing authorization token' })
};
/**
